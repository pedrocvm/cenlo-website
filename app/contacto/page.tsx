...
export const metadata = {
  title: 'Contacto — Cenlo',
  description: 'Peça uma demonstração do Cenlo. Marcamos uma conversa curta e mostramos como a Cenlo organiza a sua operação.',
}
    ...
    <section style={{ maxWidth: 980, margin: '0 auto', padding: '64px 24px 84px' }}>
      <div className="grid-two" style={{ display: 'grid', gridTemplateColumns: '.85fr 1.15fr', gap: 48, alignItems: 'start' }}>
        <div>
          ...
          <p style={{ fontSize: 16.5, color: 'var(--ink2)', marginTop: 16 }}>Se a sua operação ainda depende de mensagens soltas, pedidos anotados à mão, reservas esquecidas ou conversas perdidas no WhatsApp, fale connosco.</p>

          <div style={{ marginTop: 28, display: 'flex', flexDirection: 'column', gap: 12 }}>
            <a href="#" style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: 12, padding: '14px 16px' }}>
            ...
            <a href="mailto:ola@cenlo.pt" style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: 12, padding: '14px 16px' }}>
              ...
              <span>
                ...
                <span style={{ fontSize: 13, color: 'var(--muted)' }}>Email · respondemos a cada pedido</span>
              </span>
            </a>
          </div>
        </div>
