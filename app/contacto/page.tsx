      ...
      <section style={{ maxWidth: 980, margin: '0 auto', padding: '64px 24px 84px' }}>
        <div className="grid-two" style={{ display: 'grid', gridTemplateColumns: '.85fr 1.15fr', gap: 48, alignItems: 'start' }}>
          <div>
            ...
            <h1 className="hd" style={{ fontSize: 40, marginTop: 14, fontFamily: 'var(--font-schibsted)' }}>Pedir demonstração</h1>
            ...
            <div style={{ marginTop: 28, display: 'flex', flexDirection: 'column', gap: 12 }}>
              <a href="https://wa.me/351912333313?text=Ol%C3%A1%2C%20quero%20pedir%20uma%20demonstra%C3%A7%C3%A3o%20do%20Cenlo." target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: 12, padding: '14px 16px' }}>
              ...
              <a href="mailto:ola@cenlo.pt" style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: 12, padding: '14px 16px' }}>
              ...
              <a href="mailto:comercial@cenlo.pt" style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: 12, padding: '14px 16px' }}>
                <span style={{ width: 34, height: 34, borderRadius: 9, background: 'var(--terraBg)', color: 'var(--terra)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, flexShrink: 0 }}>@</span>
                <span>
                  <span style={{ display: 'block', fontWeight: 600, fontSize: 14.5 }}>comercial@cenlo.pt</span>
                  <span style={{ fontSize: 13, color: 'var(--muted)' }}>Parcerias e propostas comerciais</span>
                </span>
              </a>

              <a href="mailto:suporte@cenlo.pt" style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: 12, padding: '14px 16px' }}>
                <span style={{ width: 34, height: 34, borderRadius: 9, background: 'var(--terraBg)', color: 'var(--terra)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, flexShrink: 0 }}>@</span>
                <span>
                  <span style={{ display: 'block', fontWeight: 600, fontSize: 14.5 }}>suporte@cenlo.pt</span>
                  <span style={{ fontSize: 13, color: 'var(--muted)' }}>Apoio técnico e ajuda</span>
                </span>
              </a>
            </div>
          </div>
