...
export const metadata: Metadata = {
  title: 'Termos de Utilização — Cenlo',
  description: 'Condições de utilização do site da Cenlo e do pedido de demonstração dos produtos Cenlo.',
  alternates: { canonical: 'https://cenlo.pt/termos' },
  openGraph: {
    title: 'Termos de Utilização — Cenlo',
    description: 'Condições de utilização do site da Cenlo e do pedido de demonstração dos produtos Cenlo.',
    url: 'https://cenlo.pt/termos',
    type: 'website',
  },
}
...
export default function TermosPage() {
  return (
    <section style={{ maxWidth: 820, margin: '0 auto', padding: '72px 24px 84px' }}>
      <span style={{ fontSize: 13, fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--terra)' }}>Termos</span>
      <h1 className="hd" style={{ fontSize: 40, marginTop: 14, fontFamily: 'var(--font-schibsted)' }}>Termos de Utilização</h1>
      ...
      <p style={{ fontSize: 14.5, color: 'var(--muted)', borderTop: '1px solid var(--line2)', paddingTop: 20, marginTop: 30 }}>
        Questões sobre estes termos? Escreva para{' '}
